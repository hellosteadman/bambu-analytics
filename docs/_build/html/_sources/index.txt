...
Analytics <https://support.google.com/analytics/answer/2790010?hl=en-GB>`__
...
the two classes in ``bambu.analytics.providers.google`` to see how
they're hooked up.
...
uses a lot of AJAX (like `Poddle.fm <http://poddle.fm/>`__), you'll get
